...
ActiveRecord::Schema.define(version: 20170614104537) do
  ...
  create_table "bookmarks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["article_id"], name: "index_bookmarks_on_article_id", using: :btree
  ...
  create_table "saved_articles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["article_id"], name: "index_saved_articles_on_article_id", using: :btree
    t.index ["user_id"], name: "index_saved_articles_on_user_id", using: :btree
  end
